...
CREATE SCHEMA IF NOT EXISTS `site_pdo_ce` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
...
(2, 'Carlos Wagner ', 'wagner30023@hotmail.com', NULL, 'Gostaria de fazer o curso PHP do jeito certo. ');
